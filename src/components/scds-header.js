...
// ${props => {
//   props.mq === 'sm' && props.position === 'left'
//   return css`
//       display: 'none';
//   `
// }}
...
const Market = styled.div`
    ...
    color: #666;
    display: ${props => (['sm'].includes(props.mq) ? 'none' : 'block')};
`
...
function Header() {
    ...
    return (
        <StyledHeader>
            <InnerContainer position="left" mq={mq}>
                <img src={logo} alt="logo" height="30" />
                <Separator />
                <Market mq={mq}>Great Britain</Market>
            </InnerContainer>
            <InnerContainer position="right" mq={mq}>
